...
public class RecipeController {
    ...
    public String updateIngredients(@RequestParam @Pattern(regexp = "^\\w+@gmail\\.com$") String email , @RequestParam @NotBlank String token ,@PathVariable @NotNull Integer id, @PathVariable @NotBlank String ingredients){
        if(authenticationTokenService.authenticate(email , token)){
    ...
    public String updateInstructions(@RequestParam @Pattern(regexp = "^\\w+@gmail\\.com$") String email , @RequestParam @NotBlank String token ,@PathVariable @NotNull Integer id, @PathVariable @NotBlank String instructions){
        if(authenticationTokenService.authenticate(email , token)){
